# Contributing to Akka Reactive Kafka

In case of questions about the contribution process or for discussion of specific issues please visit the [akka/reactive-kafka gitter chat](https://gitter.im/akka/reactive-kafka).

## Infrastructure

* [Lightbend Contributor License Agreement](http://www.lightbend.com/contribute/cla)
* [Issue Tracker](https://github.com/akka/reactive-kafka/issues)
* [CI](https://travis-ci.org/akka/reactive-kafka)
...
* `master` – development branch for Kafka 0.9
* `0.8` – development branch for Kafka 0.8 
...
3. You should always perform your work in a Git feature branch. The branch should be given a descriptive name that explains its intent. Some teams also like adding the ticket number and/or the [GitHub](http://github.com) user ID to the branch name, these details is up to each of the individual teams.
    ...
    reactive-kafka prefers the committer name as part of the branch name, the ticket number is optional.
