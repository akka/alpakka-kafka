...
Kafka 2.5+ ([KIP-360](https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=89068820)) supports up to `5` in-flight requests with exactly-once semantics, which can improve throughput.
